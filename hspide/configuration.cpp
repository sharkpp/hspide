...
//	m_shortcutInfo[ShortcutBatchBuild].keys         = 
	m_shortcutInfo[ShortcutDebugRunSolution].keys   = QKeySequence(Qt::Key_F5);
	m_shortcutInfo[ShortcutNoDebugRunSolution].keys = QKeySequence(Qt::CTRL + Qt::Key_F5);
	m_shortcutInfo[ShortcutDebugRunProject].keys    = QKeySequence(Qt::ALT + Qt::Key_F5);
//	m_shortcutInfo[ShortcutNoDebugRunProject].keys  = 
	...
	m_shortcutInfo[ShortcutConfig].keys             = QKeySequence::Preferences;
	m_shortcutInfo[ShortcutShowProject].keys        = QKeySequence(Qt::CTRL + Qt::SHIFT + Qt::Key_P);
	m_shortcutInfo[ShortcutShowSymbol].keys         = QKeySequence(Qt::CTRL + Qt::SHIFT + Qt::Key_Y);
	m_shortcutInfo[ShortcutShowOutput].keys         = QKeySequence(Qt::CTRL + Qt::SHIFT + Qt::Key_O);
	m_shortcutInfo[ShortcutShowSearch].keys         = QKeySequence(Qt::CTRL + Qt::SHIFT + Qt::Key_S);
	m_shortcutInfo[ShortcutShowMessage].keys        = QKeySequence(Qt::CTRL + Qt::SHIFT + Qt::Key_M);
	m_shortcutInfo[ShortcutShowBreakPoint].keys     = QKeySequence(Qt::CTRL + Qt::SHIFT + Qt::Key_B);
//	m_shortcutInfo[ShortcutShowSysInfo].keys        = 
//	m_shortcutInfo[ShortcutShowVarInfo].keys        = 
}
